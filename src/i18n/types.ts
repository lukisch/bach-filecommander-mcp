...
export interface Translations {
  ...
  fc_check_cloud_lock: {
    ...
    labelTargetState: string;
    targetMissing: string;
    targetFile: string;
    targetDirectory: string;
    targetReparse: string;
    targetOther: string;
    targetUnavailable: (message: string) => string;
    labelCloudState: string;
    notCheckedCloudState: string;
    labelProcessLock: string;
    notCheckedProcessLock: string;
    labelConclusion: string;
    staticOnly: string;
    labelRisk: string;
    riskHigh: string;
    riskMedium: string;
