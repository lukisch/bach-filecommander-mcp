...
export const zh: Translations = {
  ...
  fc_check_cloud_lock: {
    ...
    notInSyncFolder: '\u2014 否',
    labelTargetState: '目标状态',
    targetMissing: '不存在（未检测到活动锁）',
    targetFile: '现有文件',
    targetDirectory: '现有目录',
    targetReparse: '现有重解析点 / 符号链接',
    targetOther: '现有特殊文件系统对象',
    targetUnavailable: (message) => '未检查：' + message,
    labelCloudState: 'Cloud Files 水合状态',
    notCheckedCloudState: '未检查：Node 没有用于 Cloud Files 属性的可移植非提升 API',
    labelProcessLock: '进程句柄锁',
    notCheckedProcessLock: '未检查：没有可移植的非提升句柄检查',
    labelConclusion: '诊断结论',
    staticOnly: 'static_risk_only - 未检测到活动重命名锁',
    labelRisk: '锁定风险',
