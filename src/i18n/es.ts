...
export const es: Translations = {
  ...
  fc_check_cloud_lock: {
    ...
    notInSyncFolder: '\u2014 No',
    labelTargetState: 'Estado del destino',
    targetMissing: 'No existe (no se detectó bloqueo activo)',
    targetFile: 'Archivo existente',
    targetDirectory: 'Directorio existente',
    targetReparse: 'Punto de análisis / enlace simbólico existente',
    targetOther: 'Objeto especial del sistema de archivos existente',
    targetUnavailable: (message) => 'No comprobado: ' + message,
    labelCloudState: 'Hidratación de Cloud Files',
    notCheckedCloudState: 'No comprobado: Node no ofrece una API portable sin elevación para atributos de Cloud Files',
    labelProcessLock: 'Bloqueo de handle de proceso',
    notCheckedProcessLock: 'No comprobado: no hay inspección portable de handles sin elevación',
    labelConclusion: 'Conclusión del diagnóstico',
    staticOnly: 'static_risk_only - no se detectó bloqueo activo de cambio de nombre',
